...
public class ModBlocks {
    ...
    public static final BlockEntityType<PressureTableEntity> PRESSURE_TABLE_ENTITY = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(PressureMakesDiamonds.MOD_ID, "demo_block_entity"), FabricBlockEntityTypeBuilder.create(PressureTableEntity::new, ModBlocks.PRESSURE_TABLE).build());
